...
Editar tarefas — duplo clique sobre a tarefa para editar o texto
...
JavaScript (Vanilla JS) — lógica de criação, edição, remoção, drag & drop e persistência
...
bash   git clone https://github.com/seu-usuario/scrum-task-manager.git

Abra o arquivo index.html no seu navegador — nenhuma instalação ou dependência necessária.
...
Editar: Dê um duplo clique na tarefa para alterar o texto.
Remover: Clique no X para excluir a tarefa.
